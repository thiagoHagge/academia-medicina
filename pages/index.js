...
export default function Home({carouselItems, news, videos, podcasts, pages}) {
	return (
		<Layout	Layout title='Academia de Medicina de Itabuna' carousel={carouselItems} noMargin pages={pages}>
